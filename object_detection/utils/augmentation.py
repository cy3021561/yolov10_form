...
inp_img_pth = "/Users/chun/Documents/Bridgent/yolov10_form/object_detection/raw_dataset/images"
inp_lab_pth = "/Users/chun/Documents/Bridgent/yolov10_form/object_detection/raw_dataset/labels"
out_img_pth = "/Users/chun/Documents/Bridgent/yolov10_form/object_detection/aug_dataset/images"
out_lab_pth = "/Users/chun/Documents/Bridgent/yolov10_form/object_detection/aug_dataset/labels"
bb_image = "/Users/chun/Documents/Bridgent/yolov10_form/object_detection/aug_dataset/bb_image"
transformed_file_name = "aug_10"
classes = ["calendar", "checkbox", "date", "dropdown_button", "input_box", "numbers", "popout_box", "radio_button", "selection_button"]
...
def get_inp_data(img_file):
    ...
    lab_pth = os.path.join(inp_lab_pth, f"{file_name}.txt")
...
def save_augmentation(trans_image, trans_bboxes, trans_file_name):
    ...
    if tot_objs:
        ...
        trans_bboxes = multi_obj_bb_yolo_conversion(trans_bboxes, classes) if tot_objs > 1 else [single_obj_bb_yolo_conversion(trans_bboxes[0], classes)]
...
if __name__ == "__main__":
    imgs = [img for img in os.listdir(inp_img_pth) if is_image_by_extension(img)]
